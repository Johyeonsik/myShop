...
<script>	
	...
	$("#tbl").on("click", "#insert", function(){
		...
		$("#tbl tr .chk:checked").each(function(){
			...
			var category1=row.find(".category1").text();
			...
			//alert(pid + "/n" + image + "/n" + title + "/n" + price);
			
			$.ajax({
				type: "post",
				url: "/product/insert",
				data: {pname:title, pimage:image, pprice:intPrice, pcate1:category1, pcate2:category2, pcate3:category3, pcate4:category4, pbrand:brand, pmaker:maker},
				success: function(){
